              ...
              (t.prototype.suikaTime = function (o) {
                try {
                  if (o.getComponent("fruitData").fruitNumber == 10) {
                    ...
                    const suikaTimer_time = performance.measure(
                      "suikaTimerStart",
                      "suikaTimerSuika"
                    );
                    let milliseconds = suikaTimer_time.startTime;

                    var GameMyScoreResult =
                      document.getElementById("GameMyScoreResult");
      ...
      function (e, t, n) {
        ...
        cc.Class({
          ...
          onLoad: function () {
            ...
            var fruitsRefreshRewordInfoButton = document.getElementById(
          ...
          gameEnd1: function () {
            ...
            var GameEndScoreScreen =
              document.getElementById("GameEndScoreScreen");
            var ThisGameScoreResult = document.getElementById(
              "ThisGameScoreResult"
            );
            let scores_text = [];
            scores_text.push(
              '<p class="thisScore">' + e.sceneScore.string + "</p>"
            );
          ...
          h = (function (e) {
            ...
            return (
              ...
              (t.prototype.adsButtonFunc = function () {
                ...
                var GameWeekScoreResult = document.getElementById(
                  "GameWeekScoreResult"
                );
                var GameMyScoreResult =
                  document.getElementById("GameMyScoreResult");
                var GameWeekSuikaScoreResult = document.getElementById(
                  "GameWeekSuikaScoreResult"
                );
                var GameMySuikaScoreResult = document.getElementById(
                  "GameMySuikaScoreResult"
                );
                ...
                if (dataloadState == false) {
                  axios
                    ...
                    .then((response) => {
                      ...
                      const weekscore = JSON.parse(
                        JSON.stringify(response.data[0])
                      );
                      const myscore = JSON.parse(
                        JSON.stringify(response.data[1])
                      );
                      const suika_score = JSON.parse(
                        JSON.stringify(response.data[2])
                      );
                      const my_suika_score = JSON.parse(
                      ...
                      for (let item of myscore) {
                        const fruits_icon =
                          "/public/res/raw-assets/" +
                          fruits_id(myscore_ranking_count) +
                          ".png";
                        myscore_text.push(
                      ...
                      for (let item of my_suika_score) {
                        ...
                        const fruits_icon =
                          "/public/res/raw-assets/50/5035266c-8df3-4236-8d82-a375e97a0d9c.png";
                        my_suika_score_text.push(
                          '<li class="list-ranking-item">' +
                            '<img src="' +
                            fruits_icon +
                            '" />' +
                      ...
                      GameMySuikaScoreResult.innerHTML =
                        my_suika_score_text.join("");
                      ...
                      for (let item of weekscore) {
                        const fruits_icon =
                          "/public/res/raw-assets/" +
                          fruits_id(weekscore_ranking_count) +
                          ".png";
                        if (weekscore_ranking_count > 3) {
                          weekscore_text.push(
                            '<li class="list-ranking-item-small col-4"><span class="rank_icon-small rank_' +
                          ...
                          weekscore_text.push(
                            '<li class="list-ranking-item"><span class="rank_icon rank_' +
                              weekscore_ranking_count +
                              '">' +
                              weekscore_ranking_count +
                              "</span>" +
                      ...
                      GameWeekSuikaScoreResult.innerHTML =
                        suika_score_text.join("");
                    });
                  dataloadState = true;
                }
              }),
